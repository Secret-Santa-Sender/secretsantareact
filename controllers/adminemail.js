...
<h1 style='color:#222222;font-family:'Open Sans', sans-serif;font-size:18px;font-weight:bold;line-height:26px;margin:14px 0 14px 0;'>Hi there, here's your link.</h1>
<p style='font-size:16px;margin:0 0 25px 0;'>Forward this to your friends!</p>
<center class='button' lang='x-button' xml:lang='x-button'>
<a href=` +
      link +
      ` style='color:#3EA23D;background-color:#3EA23D;border-color:#3EA23D;border-radius:2px;border-style:solid;color:#FFFFFF;font-size:16px;font-weight:bold;text-align:center;text-decoration:none;box-shadow:0px 1px 3px rgba(0,0,0,0.2);border-width:9px 20px;display:inline-block;margin-bottom:14px'>Register For Secret Santa!</a>
</center>
</td>
</tr>
</table>
